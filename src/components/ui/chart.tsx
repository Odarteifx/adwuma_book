...
>(
  (
    ...
    try {
      config = useChart().config;
    } catch {
      // Tooltip may render in portal outside ChartContainer
    }
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      const value =
        !labelKey && typeof label === "string"
          ? label
          : item.payload[labelKey as keyof typeof item.payload] ?? item.payload[label as keyof typeof item.payload];
      return (
        <div
          className={cn(
            "font-medium",
